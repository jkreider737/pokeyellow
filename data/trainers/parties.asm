...
; Jessie & James
	...
	db 37, WEEZING, ARBOK, MEOWTH, 0 ; Silph Co. 11F
; Unused
	db 16, KOFFING, 0
	db 27, KOFFING, 0
	db 29, WEEZING, 0
...
LtSurgeData:
	db $FF, 26, VOLTORB, 26, MAGNEMITE, 28, RAICHU, 0

ErikaData:
	db $FF, 30, TANGELA, 32, VICTREEBEL, 32, VILEPLUME, 0

KogaData:
	db $FF, 44, VENONAT, 44, GOLBAT, 44, ARBOK, 46, VENOMOTH, 0
...
Rival2Data:
; SS Anne 2F
	db $FF, 19, SPEAROW, 18, RATTATA, 18, SANDSHREW, 20, EEVEE, 0
; Pokémon Tower 2F
...
LanceData:
	db $FF, 58, GYARADOS, 56, DRAGONITE, 56, DRAGONITE, 60, AERODACTYL, 62, DRAGONITE, 0
