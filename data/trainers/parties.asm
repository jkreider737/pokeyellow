...
BrunoData:
	db $FF, 53, GOLEM, 55, HITMONCHAN, 55, HITMONLEE, 56, GOLEM, 58, MACHAMP, 0
...
LtSurgeData:
	db $FF, 24, ELECTABUZZ, 28, RAICHU, 0

ErikaData:
	db $FF, 30, TANGELA, 32, VICTREEBEL, 32, VILEPLUME, 0

KogaData:
	db $FF, 44, MUK, 46, WEEZING, 48, VENONAT, 50, VENOMOTH, 0

BlaineData:
	db $FF, 46, MAGMAR, 48, NINETALES, 50, RAPIDASH, 54, ARCANINE, 0
...
LanceData:
	db $FF, 58, GYARADOS, 56, DRAGONAIR, 56, KANGASKHAN, 60, AERODACTYL, 62, DRAGONITE, 0
