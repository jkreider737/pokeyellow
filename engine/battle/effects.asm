...
TriAttackEffect: ; NEW FEATURE tri attack effect ; https://github.com/RainbowMetalPigeon/ExtremeYellow/blob/50e283188e45c70da4d92c2a243728baeaf9e7f0/engine/battle/move_effects/triattack.asm
	xor a
	ld [wAnimationType], a
...
; we are attacking
	...
	call BattleRandom ; edited into the copy
...
.paralyze1
	...
	call PlayBattleAnimation2 ; edited into the copy
...
.burn1
	...
	ld a, SHAKE_SCREEN_ANIM
	call PlayBattleAnimation2 ; edited into the copy
	ld hl, BurnedText ; edited into the copy present in the burn file
	jp PrintText
.freeze1
	...
	ld a, SHAKE_SCREEN_ANIM
	call PlayBattleAnimation2 ; edited into the copy
	ld hl, FrozenText ; edited into the copy here
	jp PrintText
...
.paralyze2
	...
	call PlayBattleAnimation2 ; edited into the copy2
